...
function componentDidUpdate(component, init, prev) {
  ...
  console.log('will update style',  activeKey, prev && prev.activeKey);

  //  if (activeTab && (init || activeKey !== prev.activeKey))  加入 activeKey 判断
  if (activeTab) {
...
export default class InkTabBarNode extends React.Component {
  ...
  componentDidUpdate(prev) {
    componentDidUpdate(this, false, prev);
  }
